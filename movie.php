...
<div id="main-container" class="container-fluid">
    <div class="row">
        <div class="offset-md-3 col-md-6 movie-container">
            ...
            <iframe src="<?= $movie->trailer ?>" width="560" height="315" frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        ...
        <div class="offset-md-1 col-md-10" id="reviews-container">
            ...
            <?php if (!empty($userData) && !$userOwnsMovie && !$alreadyReview): ?>
            <div class="col-md-12" id="review-form-container">
                <h4>Envie sua avaliação</h4>
                <p class="pag-descriprion">Preencha o formulario com a nota e comentario sobre o filme</p>
