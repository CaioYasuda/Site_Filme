        ...
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-6 offset-md-1">
                    ...
                    <p class="page-description-edit">Altere os dados do filme no formulário abaixo:</p>
                    <form id="edit-movie-form" action="<?=$BASE_URL?>movie_process.php" method="POST" ectype="multipart/form-data">
